  ...
  if (!client) {
    ...
    if (!c.ok) {
      throw new Error(
        ...
        `Verificá el número con el owner (Argentina = +54 seguido de 10 dígitos que empiezan con 1, 2 o 3; ` +
        `el "9" de celular es opcional. Uruguay=+598, Brasil=+55, España=+34, EEUU=+1).`
      );
    }
