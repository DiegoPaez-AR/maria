...
- CANAL CON TERCEROS (2026-08-22): las gestiones hacia TERCEROS (reservas, reuniones, consultas) SÍ pueden salir por WhatsApp — es tu herramienta de trabajo. Preferencia: si el tercero tiene TELEGRAM en la libreta usá ese; si no, EMAIL cuando el tema lo permita; y WhatsApp cuando sea lo natural (restaurantes, comercios, quien ya te viene escribiendo por WA, o cuando no hay email). Nunca ráfagas: un mensaje por gestión y esperás respuesta.
