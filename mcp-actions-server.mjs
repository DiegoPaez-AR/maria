...
const TERCERO   = process.env.MARIA_TURN_TERCERO === '1';
...
function postAccion(accion) {
  return new Promise((resolve) => {
    ...
    const payload = JSON.stringify({ usuarioId: USUARIO, accion, canalOrigen: CANAL, turnStartTs: START_TS, chatKey: CHAT_KEY, turnoTercero: TERCERO });
