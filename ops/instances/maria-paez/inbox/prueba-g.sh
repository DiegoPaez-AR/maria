...
curl -s -m 40 -X POST "http://127.0.0.1:$PORT/accion" -H "x-intensa-secret: $SECRET" -H 'Content-Type: application/json' \
  -d "{\"usuarioId\":1,\"accion\":{\"tipo\":\"enviar_wa\",\"a\":\"541132317896@c.us\",\"texto\":\"🅶 Prueba G — con Turn On en el task. Si esto llegó con la pantalla previamente APAGADA y sin que toques nada, el Tasker quedó blindado. 🏆\"},\"canalOrigen\":\"whatsapp\"}" \
