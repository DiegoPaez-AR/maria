...
console.log('encolado id=' + ob.encolar({ usuarioId: owner.id, numero: num, texto: 'Prueba 9: circuito completo. Si esto llega y no se repite, Maria ya puede iniciar por WhatsApp.' }));
"
