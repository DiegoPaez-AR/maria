#!/bin/bash
# aplicar-max-thinking-1024.sh — fija MAX_THINKING_TOKENS=1024 en la instancia maria-paez.
set -uo pipefail
export PATH="/usr/local/bin:/usr/bin:/bin:${PATH:-}"
echo "═══ APLICAR MAX_THINKING_TOKENS=1024 — $(date '+%Y-%m-%d %H:%M %z') ═══"
