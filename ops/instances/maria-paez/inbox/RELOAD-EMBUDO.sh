...
grep -c "aplicarEmbudo" /root/secretaria/wa-send.js /root/secretaria/whatsapp-handler.js
ls /root/secretaria/state/maria-paez/wa-apagado && echo "wa-apagado sigue puesto (bien: la revisión corre)"
