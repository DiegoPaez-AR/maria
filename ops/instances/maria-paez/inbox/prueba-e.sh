...
curl -s -m 40 -X POST "http://127.0.0.1:$PORT/accion" -H "x-intensa-secret: $SECRET" -H 'Content-Type: application/json' \
  -d "{\"usuarioId\":1,\"accion\":{\"tipo\":\"enviar_wa\",\"a\":\"541132317896@c.us\",\"texto\":\"🅴 Prueba E — pantalla apagada sin cargar. Si esto te llegó, anotá CÓMO: ¿salió solo al despertar la pantalla, o ya estaba en el chat esperando el tap?\"},\"canalOrigen\":\"whatsapp\"}" \
