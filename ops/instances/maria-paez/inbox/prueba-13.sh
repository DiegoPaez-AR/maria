...
curl -s -m 40 -X POST "http://127.0.0.1:$PORT/accion" -H "x-intensa-secret: $SECRET" -H 'Content-Type: application/json' \
  -d "{\"usuarioId\":1,\"accion\":{\"tipo\":\"enviar_wa\",\"a\":\"541132317896@c.us\",\"texto\":\"🌉 Prueba v1.3 por la COLA — con matcheo flexible. Si llegó, MariaBridge reemplaza al Tasker. Si no, la app ya me mandó el diagnóstico del mismatch.\"},\"canalOrigen\":\"whatsapp\"}" \
