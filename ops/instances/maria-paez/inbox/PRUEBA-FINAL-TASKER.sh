...
console.log('encolado id=' + ob.encolar({ usuarioId: owner.id, numero: num, texto: 'Prueba final: si esto salio sin que toques nada, Maria ya puede iniciar conversaciones por WhatsApp.' }));
"
