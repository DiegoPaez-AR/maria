...
const translations = {
  es: {
    ...
    'plan.2.name': 'Pro',
    'plan.2.desc': 'Para profesionales y founders. Todo lo de Personal + gestiones autónomas + prioridad.',
    'plan.2.f1': 'Todo lo de Personal',
    'plan.2.f2': 'Maria escribe mails en tu nombre (desde su propia cuenta)',
  ...
  en: {
    ...
    'plan.2.name': 'Pro',
    'plan.2.desc': 'For professionals and founders. Everything in Personal + autonomous errands + priority.',
    'plan.2.f1': 'Everything in Personal',
    'plan.2.f2': 'Maria emails on your behalf (from her own account)',
