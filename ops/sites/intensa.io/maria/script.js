...
const translations = {
  es: {
    ...
    'hero.sub': 'Le escribís por WhatsApp o Telegram como a cualquier persona. Ella agenda, contacta a tus terceros por mail o WhatsApp desde su propia cuenta, te recuerda lo que te olvidás y maneja tu día. Y se acuerda de todo, siempre. Sin app que instalar.',
    ...
    'plan.1.f6': 'Memoria de largo plazo — se acuerda de todo, siempre',
    ...
    'faq.11.q': '¿Puedo hablar con Maria por Telegram?',
    'faq.11.a': 'Sí — Maria atiende igual de bien por Telegram, y muchos usuarios lo prefieren: es más rápido para audios y archivos. Te vinculás en un minuto y podés alternar de canal cuando quieras: Maria es una sola y se acuerda de todo en los dos.',
    'mem.h2': 'Maria se acuerda de todo. <em>Y eso cambia todo.</em>',
    'mem.sub': 'Los asistentes de IA arrancan de cero en cada conversación. Maria no: tiene memoria de largo plazo, curada por contacto y por gestión.',
    'mem.p1': 'Se acuerda de que Manuel todavía no confirmó la reunión del lunes — y lo persigue sola. De que tu socio prefiere que le escriban por mail. De qué quedó abierto con cada persona, aunque hayan pasado semanas. De cómo te gusta agendar, a quién copiar, qué no hace falta preguntarte dos veces.',
    'mem.p2': '<strong>Cuanto más la usás, más tuya es.</strong> A la semana te sorprende. Al mes, no sabés cómo trabajabas sin ella.',
    'faq.12.q': '¿Maria se acuerda de las conversaciones anteriores?',
    'faq.12.a': 'Sí — es su superpoder. Memoria de largo plazo real: contactos, acuerdos, pendientes, preferencias y el hilo de cada gestión, entre canales y a lo largo del tiempo. No es un chat que empieza de cero: es una secretaria que te conoce.',
  ...
  en: {
    ...
    'hero.sub': 'Talk to her on WhatsApp or Telegram like to anyone. She books meetings, reaches out to your contacts by email or WhatsApp from her own account, reminds you what you forgot and runs your day. And she remembers everything, always. No app to install.',
    ...
    'faq.11.q': 'Can I talk to Maria on Telegram?',
    'faq.11.a': 'Yes — Maria works just as well on Telegram, and many users prefer it: it\'s faster for voice notes and files. Linking takes a minute, and you can switch channels anytime: Maria is one and the same, and remembers everything on both.',
    'mem.h2': 'Maria remembers everything. <em>And that changes everything.</em>',
    'mem.sub': 'AI assistants start from zero in every conversation. Maria doesn\'t: she has real long-term memory, curated per contact and per task.',
    'mem.p1': 'She remembers that Manuel still hasn\'t confirmed Monday\'s meeting — and chases him herself. That your partner prefers email. What\'s still open with each person, even weeks later. How you like to schedule, who to CC, what she never needs to ask twice.',
    'mem.p2': '<strong>The more you use her, the more yours she becomes.</strong> After a week she surprises you. After a month, you can\'t imagine working without her.',
    'faq.12.q': 'Does Maria remember previous conversations?',
    'faq.12.a': 'Yes — it\'s her superpower. Real long-term memory: contacts, agreements, to-dos, preferences and the thread of every task, across channels and over time. Not a chat that starts from zero: an assistant who knows you.',
