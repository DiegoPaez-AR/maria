...
const translations = {
  es: {
    ...
    'faq.10.q': '¿Maria se acuerda de las conversaciones anteriores?',
    'faq.10.a': 'Sí — es su superpoder. Memoria de largo plazo real: contactos, acuerdos, pendientes, preferencias y el hilo de cada gestión, entre canales y a lo largo del tiempo. No es un chat que empieza de cero: es una secretaria que te conoce.',
  ...
  en: {
    ...
    'faq.10.q': 'Does Maria remember previous conversations?',
    'faq.10.a': 'Yes — it\'s her superpower. Real long-term memory: contacts, agreements, to-dos, preferences and the thread of every task, across channels and over time. Not a chat that starts from zero: an assistant who knows you.',
