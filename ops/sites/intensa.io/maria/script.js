...
const translations = {
  es: {
    'title': 'Maria — Tu secretaria personal con IA, 24/7 por WhatsApp y Telegram',
    'meta.desc': 'Maria agenda reuniones, coordina con terceros por su propia cuenta, gestiona pendientes y te responde por WhatsApp o Telegram. Sin app que instalar, sin curva de aprendizaje.',
    'nav.que': 'Qué hace', 'nav.casos': 'Para quién', 'nav.planes': 'Precio', 'nav.cta': 'Suscribirme',
    ...
    'hero.sub': 'Le escribís por WhatsApp o Telegram como a cualquier persona. Ella agenda, contacta a tus terceros por mail o WhatsApp desde su propia cuenta, te recuerda lo que te olvidás y maneja tu día. Sin app que instalar.',
    ...
    'dif.4.t': 'Maria',
    'dif.4.p': 'Vive donde vos ya vivís: WhatsApp o Telegram. Cero app nueva, cero login, cero curva de aprendizaje.',
    'planes.h2': 'Precio simple. <em>Todo incluido.</em>',
    'planes.sub': 'Sin permanencia. Cancelás cuando quieras.',
    'plan.period': '/mes',
    'plan.trial': 'Primeros 7 días gratis',
    'plan.1.name': 'Maria',
    'plan.1.desc': 'Tu secretaria personal con IA, disponible 24/7 por WhatsApp y Telegram. Sin curva de aprendizaje.',
    ...
    'faq.9.q': '¿Puedo hablar con Maria por Telegram?',
    'faq.9.a': 'Sí — Maria atiende igual de bien por Telegram, y muchos usuarios lo prefieren: es más rápido para audios y archivos. Te vinculás en un minuto y podés alternar de canal cuando quieras: Maria es una sola y se acuerda de todo en los dos.',
    ...
    'caps.no.1': 'No tiene panel web — toda la operación es por chat (WhatsApp o Telegram).',
  ...
  en: {
    'title': 'Maria — Your AI personal assistant, 24/7 on WhatsApp & Telegram',
    'meta.desc': 'Maria books meetings, coordinates with third parties from her own account, manages to-dos and replies via WhatsApp or Telegram. No app to install, no learning curve.',
    'nav.que': 'What it does', 'nav.casos': 'Who it\'s for', 'nav.planes': 'Pricing', 'nav.cta': 'Subscribe',
    'hero.eyebrow': 'AI personal assistant · available 24/7',
    'hero.h1': 'More to do than hours in the day. <em>Maria handles it.</em>',
    'hero.sub': 'Talk to her on WhatsApp or Telegram like to anyone. She books meetings, reaches out to your contacts by email or WhatsApp from her own account, reminds you what you forgot and runs your day. No app to install.',
    ...
    'dif.4.t': 'Maria',
    'dif.4.p': 'Lives where you already live: WhatsApp or Telegram. Zero new app, zero login, zero learning curve.',
    'planes.h2': 'Simple pricing. <em>Everything included.</em>',
    'planes.sub': 'No lock-in. Cancel anytime.',
    'plan.period': '/mo',
    'plan.trial': 'First 7 days free',
    'plan.1.name': 'Maria',
    'plan.1.desc': 'Your AI personal assistant, available 24/7 over WhatsApp & Telegram. No learning curve.',
    ...
    'faq.9.q': 'Can I talk to Maria on Telegram?',
    'faq.9.a': 'Yes — Maria works just as well on Telegram, and many users prefer it: it\'s faster for voice notes and files. Linking takes a minute, and you can switch channels anytime: Maria is one and the same, and remembers everything on both.',
    ...
    'caps.no.1': 'No web dashboard — everything happens in chat (WhatsApp or Telegram).',
