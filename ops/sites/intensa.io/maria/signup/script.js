...
const TR = {
  es: {
    ...
    'step1.sub': 'Primero te validamos por email y WhatsApp. 7 días gratis y después USD 39.99/mes. Cancelás cuando quieras.',
  ...
  en: {
    ...
    'step1.sub': 'First we verify your email and WhatsApp. 7 days free, then USD 39.99/mo. Cancel anytime.',
