...
const TR = {
  es: {
    ...
    'step1.sub': 'Primero te validamos por email y WhatsApp. Después pagás. USD 49/mes con prueba gratuita de 7 días.',
  ...
  en: {
    ...
    'step1.sub': 'First we verify your email and WhatsApp. Then you pay. USD 49/mo with a 7-day free trial.',
